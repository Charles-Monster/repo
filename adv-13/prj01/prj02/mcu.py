...
class MQTT:
    def __init__(self, clientId, server, user, password, keepalive):
        self.clientId = clientId
        self.server = server
        self.user = user
        self.password = password
        self.keepalive = keepalive
        self.client = MQTTClient(self.clientId,self.server,user=self.user,password=self.password,keepalive=self.keepalive)
